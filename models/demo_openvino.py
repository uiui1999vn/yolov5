...
def resize(image, size, keep_aspect_ratio, interpolation=cv2.INTER_CUBIC):
...
def main_IE_infer():
    ...
    # NMS
    batch_detections = w_non_max_suppression(outputx, num_classes, conf_thres=0.4, nms_thres=0.5)
    end = time.time()
